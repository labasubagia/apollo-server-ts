// Builtin Scalar
export const MOCK_GRAPHQL_INT = 1;
export const MOCK_GRAPHQL_FLOAT = 1.5;
export const MOCK_GRAPHQL_STRING = 'Hello World';
...
export const MOCK_MONGO_POST_ID = '0123456789abcdef01234568';
